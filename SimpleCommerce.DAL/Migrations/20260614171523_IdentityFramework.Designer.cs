...
namespace SimpleCommerce.DAL.Migrations
{
    ...
    [Migration("20260614171523_IdentityFramework")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleCommerce.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("SimpleCommerce.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SimpleCommerce.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimpleCommerce.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleCommerce.Models.OrderItem", b =>
                {
                    b.HasOne("SimpleCommerce.Models.Order", "Order")
                        .WithMany("Items")
